========================================================================
    KONSOLENANWENDUNG: EvictPrefetchTime-Projektübersicht
========================================================================

Diese EvictPrefetchTime-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre EvictPrefetchTime-Anwendung besteht.


EvictPrefetchTime.vcxproj
...
EvictPrefetchTime.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen EvictPrefetchTime.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
